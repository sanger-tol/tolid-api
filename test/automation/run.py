...
from pabot import *
from scripts.sts_automation_frontend.webdriver.web_driver_manager import WebDriverManagerBase
from scripts.sts_automation_frontend.webdriver.chrome import ChromeDriverManager
from scripts.sts_automation_frontend.webdriver.gecko import GeckoDriverManager
from scripts.sts_automation_frontend.webdriver.edge import EdgeChromiumDriverManager
import subprocess
...
test_config = {
    ...
    'test_app_path': os.path.join(current_dir, 'app', 'testcases'),
...
parser = argparse.ArgumentParser(
    description='STS Frontend Automation test project.')
...
with open(os.path.join(current_dir, '_config','config_{}.yaml').format(test_config.get('env'))) as file:
